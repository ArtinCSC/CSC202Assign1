...
/**
 * Driver A program that calculate two big integer in an ArrayList Artin
 * Malekian Dr. Franssell CSC 202 - Assignment #1  20 February 2017
 */
...
public class BigIntDriver {
	...
	public static void main(String[] args) {
		...
		b1 = new BigInt("-237");
		b3 = b1.add(+17);
		System.out.println("0) sum b3 is (" + b1 + ") + (" + +17 + ") = " + b3);
		b3 = b1.subtract(+17);
		System.out.println("difference b3 is (" + b1 + ") - (" + +17 + ") = " + b3);
		b3 = b1.multiply(+17);
		System.out.println("product b3 is " + b1 + " * " + +17 + " = " + b3);
		b3 = b1.divideBy(+17);
		System.out.println("quotient b3 is " + b1 + " / " + +17 + " = " + b3);
		b3 = b1.modulus(+17);
		System.out.println("modulus b3 is " + b1 + " mod " + +17 + " = " + b3);

		b1 = new BigInt("-0");
		b2 = new BigInt("+0");
		b3 = b1.add(b2);
		System.out.println("\n1) sum b3 is (" + b1 + ") + (" + b2 + ") = " + b3);
		b3 = b1.subtract(b2);
